---
name: "SyncLoop: Testing Guide"
description: "Test patterns and strategies"
applyTo: "{tests,test,__tests__}/**/*"
---
...
| Document | Purpose |
|----------|---------|
| [../validate-env.md](validate-env.instructions.md) | Gate orchestration (test gate details) |
| [refactoring-workflow.md](refactoring-workflow.instructions.md) | Safe code movement (tests after each move) |
