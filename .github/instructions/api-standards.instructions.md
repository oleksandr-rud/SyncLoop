---
name: "SyncLoop: API Standards"
description: "Boundary contracts and API conventions"
applyTo: "{routes,routers,controllers,api}/**/*"
---
...
| Document | Purpose |
|----------|---------|
| [../validate-n.md](validate-n.instructions.md) | Contract compatibility checks (NEIGHBOR) |
| [code-patterns.md](code-patterns.instructions.md) | P5 (Transport Route), P6 (Typed Models) |
