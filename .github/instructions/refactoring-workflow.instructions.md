---
name: "SyncLoop: Refactoring Workflow"
description: "4-phase refactoring checklist"
applyTo: "**/*"
---
...
| Document | Purpose |
|----------|---------|
| [../validate-env.md](validate-env.instructions.md) | Stage 1 gates (type check, tests) |
| [../validate-n.md](validate-n.instructions.md) | Stage 2 neighbor checks (boundary impact) |
| [testing-guide.md](testing-guide.instructions.md) | Regression test strategy |
